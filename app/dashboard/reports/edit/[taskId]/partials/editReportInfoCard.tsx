  ...
  return (
    <div className="bg-[#6168FF] rounded-3xl p-8 shadow-xl text-white mb-6">
      <div className="flex justify-between items-start mb-6 border-b border-white/20 pb-4">
        ...
        <div className="bg-red-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-sm animate-pulse">
          REVISION REQUIRED
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-6 gap-x-8">
        <div>
          ...
          <p className="text-lg font-bold mt-1">{reportDetail?.docNumber}</p>
        </div>
